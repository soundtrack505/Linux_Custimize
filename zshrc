...
export PATH=/usr/local/bin:$PATH:/usr/local/go/bin:/home/soundtrack/.local/bin
...
alias _i='sudo -i'
alias please='sudo'
alias vpn='sudo openvpn $HOME/Downloads/soundtrack.ovpn'
alias fucking='sudo'
alias wb='feroxbuster'
alias u='sudo apt update && sudo apt full-upgrade -y && sudo apt dist-upgrade -y && sudo apt autoremove -y'
alias open='xdg-open '
...
alias responder='sudo python3.11 /usr/share/responder/Responder.py'
