# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
...
# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
# Testttttttttttdskfljsdlkfhsdlfhailf hlihf; o
function kitty
{
  ...
  ############### HELP ###############
  $Help = "
kitty - Netcat, The Powershell Version
Github Repository: https://github.com/besimorhino/kitty

This script attempts to implement the features of netcat in a powershell
script. It also contains extra features such as built-in relays, execute
powershell, and a dnscat2 client.

Usage: kitty [-c or -l] [-p port] [options]
  ...
  -i  <input>     Input. Provide data to be sent down the pipe as soon as a connection is
                  ...
                  kitty, like 'aaaaaa' | kitty -c 10.1.1.1 -p 80
            
  -o  <type>      Output. Specify how kitty should return information to the console.
                  Valid options are 'Bytes', 'String', or 'Host'. Default is 'Host'.
            
  -of <path>      Output File.  Specify the path to a file to write output to.
            
  -d              Disconnect. kitty will disconnect after the connection is established
                  and the input from -i is sent. Used for scanning.
            
  -rep            Repeater. kitty will continually restart after it is disconnected.
                  Used for setting up a persistent server.
                  
  -g              Generate Payload.  Returns a script as a string which will execute the
                  kitty with the options you have specified. -i, -d, and -rep will not
                  be incorporated.
